...
export function GlobalSearch() {
  ...
  const searchItems = useMemo(() => {
    const allItems: { title: string; url: string; icon?: any; group?: string }[] = []
        ...
        group.items.forEach((item: any) => {
          ...
          if (item.url && item.url !== "#") {
            allItems.push({
              ...
              url: item.url,
              icon: item.icon,
              group: group.label || workspace?.name
            })
          }
          if (item.items) {
  ...
  return (
    <>
      ...
      <CommandDialog
        ...
        className="
          **:data-[slot=command-input-wrapper]:p-0! **:data-[slot=command-input-wrapper]:border-b
          **:data-[slot=input-group]:h-16! **:data-[slot=input-group]:bg-transparent! **:data-[slot=input-group]:border-none! **:data-[slot=input-group]:shadow-none! **:data-[slot=input-group]:px-6
          **:data-[slot=command-input]:h-full! **:data-[slot=command-input]:text-lg **:data-[slot=command-input]:font-medium
          **:data-[slot=input-group-addon]:order-first! **:data-[slot=input-group-addon]:p-0! **:data-[slot=input-group-addon]:mr-4
          **:data-[slot=input-group-addon]_[svg]:size-5 **:data-[slot=input-group-addon]_[svg]:opacity-40
          **:data-[slot=command-item]:px-4 **:data-[slot=command-item]:py-4 **:data-[slot=command-item]:rounded-xl **:data-[slot=command-item]:text-sm
          **:data-[slot=command-group]_[cmdk-group-heading]]:px-3 **:data-[slot=command-group]_[cmdk-group-heading]]:py-2 **:data-[slot=command-group]_[cmdk-group-heading]]:text-[10px] **:data-[slot=command-group]_[cmdk-group-heading]]:font-bold **:data-[slot=command-group]_[cmdk-group-heading]]:text-muted-foreground/60 **:data-[slot=command-group]_[cmdk-group-heading]]:uppercase **:data-[slot=command-group]_[cmdk-group-heading]]:tracking-widest
          **:data-[slot=command-list]:max-h-[500px]
        "
      >
