...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent
        className={cn("overflow-hidden rounded-xl! p-0", dialogContentClassName)}
        showCloseButton={showCloseButton}
      >
        <Command
          className={cn(
            "**:data-[slot=command-input-wrapper]:border-b **:data-[slot=command-input]:h-12 **:data-[slot=command-item]:px-3 **:data-[slot=command-item]:py-3 **:data-[slot=command-list]:max-h-[300px]",
            className
          )}
        >
          {children}
