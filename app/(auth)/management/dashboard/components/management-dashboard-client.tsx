...
export function ManagementDashboardClient() {
  ...
  return (
    ...
    //       <OvertimeCard
    //         monthlyHours={attendance_productivity.monthly_overtime_hours}
    //       />
    //     </div>
    //   </div>
    ...
    //       data={workforce_overview.distribution.department}
    //     />
    ...
    //       data={workforce_overview.distribution.location}
    //     />
