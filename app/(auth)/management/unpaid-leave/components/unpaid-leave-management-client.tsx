...
export function UnpaidLeaveManagementClient() {
    ...
    const [settleStatus, setSettleStatus] = React.useState<string>(getParam('settle_status', 'all'));
    ...
    }), [debouncedSearch, typeId, departmentId, status, settleStatus, startDate, endDate]);
    ...
    const hasActiveFilters = search !== '' || typeId !== null || departmentId !== null || status !== 'all' || settleStatus !== 'all' || startDate !== undefined || endDate !== undefined;
        ...
        <div className="space-y-6">
            ...
            >
                <FilterGrid cols={4}>
                    ...
                    <Select value={settleStatus} onValueChange={(v) => {
                        setSettleStatus(v);
