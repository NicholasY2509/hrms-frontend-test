...
import {
  ...
  useClearQueue,
  useRestartQueue,
} from "@/modules/audit/hooks/use-tasks"
...
import { ReloadFreeIcons, Trash } from "@hugeicons/core-free-icons"
...
export function TaskLogClient() {
  ...
  const { clearQueue, isLoading: isClearing } = useClearQueue()
  const { restartQueue, isLoading: isRestarting } = useRestartQueue()
  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        >
          <HugeiconsIcon icon={ReloadFreeIcons} className="mr-2 h-4 w-4" />
          Restart Workers
        </Button>
      </PageHeader>
